...
3. **Knowledge Ingestion Quarantine:** Direct database writes, YouTube scrapers, Obsidian vault modifications, NotebookLM sidecar API executions, and Higgsfield AI API calls are locked. Intake resources must be staged in dedicated folders with human review gates.
