# 🕸️ Grounded Intelligence Graph: graph_2026-05-31

* **Created At:** 2026-05-31T17:48:42.835Z
* **Local Only:** Yes
...
### Node: source_response_1
- **Node ID:** source_response_1
- **Type:** source_response
- **Title:** notebooklm_normalized_response_notebooklm_live_response_sample_2026-05-31.md
- **Source File:** notebooklm_insight_index_2026-05-31_1780248273.md
- **Summary:** The raw normalized response file serving as the grounded source data.
- **Confidence:** High
- **Tags:** None
...
- **Type:** citation
- **Title:** [1]
- **Source File:** notebooklm_citation_map_2026-05-31_1780248297.md
...
- **Confidence:** High
- **Tags:** Ingest process handles notes in read-only mode to prevent write conflicts.
- **Review Status:** staged_for_manual_review
...
- **Confidence:** High
- **Tags:** Staged files reside under the outputs folder for validation checks.
- **Review Status:** staged_for_manual_review
...
- **Confidence:** High
- **Tags:** Weak claims analysis identifies 4 key segments requiring additional documentation.
- **Review Status:** staged_for_manual_review

### Node: weak_claim_8
- **Node ID:** weak_claim_8
- **Type:** weak_claim
- **Title:** Recursive transcript scanning without limits
- **Source File:** notebooklm_weak_claims_2026-05-31_1780248320.md
...
### Node: workflow_card_14
- **Node ID:** workflow_card_14
- **Type:** workflow_card
- **Title:** SEO landing page crawling validation
- **Source File:** notebooklm_workflow_cards_2026-05-31_1780248342.md
...
- **Source File:** notebooklm_workflow_cards_2026-05-31_1780248342.md
- **Summary:** Productivity Agent council member overseeing operations.
- **Confidence:** High
- **Tags:** None
- **Review Status:** staged_for_manual_review
...
### Node: workflow_card_18
- **Node ID:** workflow_card_18
- **Type:** workflow_card
...
### Node: workflow_card_22
- **Node ID:** workflow_card_22
- **Type:** workflow_card
...
### Node: os_module_suggestion_26
- **Node ID:** os_module_suggestion_26
- **Type:** os_module_suggestion
- **Title:** programmatic-seo-validator
- **Source File:** notebooklm_os_module_suggestions_2026-05-31_1780248374.md
...
### Node: os_module_suggestion_28
- **Node ID:** os_module_suggestion_28
- **Type:** os_module_suggestion
...
### Node: os_module_suggestion_30
- **Node ID:** os_module_suggestion_30
- **Type:** os_module_suggestion
...
### Node: obsidian_staged_note_33
- **Node ID:** obsidian_staged_note_33
- **Type:** obsidian_staged_note
- **Title:** 🛰️ NotebookLM MCP Live Query Response
- **Source File:** notebooklm_staged_obsidian_note_2026-05-31_1780248403.md
- **Summary:** Unified staged markdown note compiled and formatted for manual review.
- **Confidence:** High
- **Tags:** None
- **Review Status:** staged_for_manual_review
...
- **Type:** derived_from
- **From:** insight_2
- **To:** source_response_1
- **Rationale:** Insight was derived directly from the source response text.
- **Confidence:** High
...
- **From:** citation_5
- **To:** source_response_1
- **Rationale:** Citation supports claim: "Actionable staging configuration validation" in the source response.
- **Confidence:** High
...
- **From:** weak_claim_8
- **To:** source_response_1
- **Rationale:** Claim contradicts system safety constraints or lacks documented evidence.
- **Confidence:** High
...
- **From:** weak_claim_8
- **To:** risk_9
- **Rationale:** Weak claim introduces system risk requiring mitigation.
- **Confidence:** High

### Edge: edge_9
- **Edge ID:** edge_9
- **Type:** becomes_next_action
- **From:** weak_claim_8
- **To:** next_action_10
- **Rationale:** Prescribed verification step to resolve the weak claim.
- **Confidence:** High
...
- **Edge ID:** edge_13
- **Type:** derived_from
- **From:** workflow_card_14
- **To:** insight_2
- **Rationale:** Workflow card is derived from the parsed key insight node.
- **Confidence:** High
...
- **From:** workflow_card_14
- **To:** agent_15
- **Rationale:** Workflow execution is owned by the productivity agent.
- **Confidence:** High
...
- **From:** workflow_card_14
- **To:** risk_16
- **Rationale:** Workflow steps introduce potential risks requiring manual checks.
- **Confidence:** High
...
- **From:** workflow_card_14
- **To:** next_action_17
- **Rationale:** Mitigation next action to resolve workflow risk or execute setup.
- **Confidence:** High

### Edge: edge_17
- **Edge ID:** edge_17
- **Type:** derived_from
- **From:** workflow_card_18
- **To:** insight_3
- **Rationale:** Workflow card is derived from the parsed key insight node.
- **Confidence:** High
...
### Edge: edge_25
- **Edge ID:** edge_25
- **Type:** suggests_module
- **From:** insight_2
- **To:** os_module_suggestion_26
- **Rationale:** Insight suggests the creation or expansion of an OS module.
- **Confidence:** High

### Edge: edge_26
- **Edge ID:** edge_26
- **Type:** owned_by_agent
- **From:** os_module_suggestion_26
- **To:** agent_15
- **Rationale:** Module operations and maintenance are owned by the productivity agent.
- **Confidence:** High
...
- **From:** os_module_suggestion_26
- **To:** next_action_27
- **Rationale:** Prescribed next steps to build or integrate the OS module.
- **Confidence:** High
...
### Edge: edge_34
- **Edge ID:** edge_34
- **Type:** stages_to_obsidian
- **From:** obsidian_staged_note_33
- **To:** source_response_1
- **Rationale:** Obsidian staged note aggregates all intelligence sections for the source response.
- **Confidence:** High
