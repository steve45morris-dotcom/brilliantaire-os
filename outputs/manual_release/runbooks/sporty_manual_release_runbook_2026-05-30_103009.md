...
### 📋 Copy-Paste Sheet: Facebook

- **Platform:** Facebook
- **Copy Source:** `outputs/platform_adapters/facebook/sporty_facebook_package_2026-05-30_072308.md`
- **Asset To Attach:** `Sporty Promo Image assets and group artwork`
- **CTA Link:** `Join the Brilliantier movement and unlock early access.`
...
### 📋 Copy-Paste Sheet: WhatsApp

- **Platform:** WhatsApp
- **Copy Source:** `outputs/platform_adapters/whatsapp/sporty_whatsapp_package_2026-05-30_072308.md`
- **Asset To Attach:** `Sporty Release Announcement graphic card`
- **CTA Link:** `Join the Brilliantier movement and unlock early access.`
...
### 📋 Copy-Paste Sheet: Obsidian

- **Platform:** Obsidian
- **Copy Source:** `outputs/platform_adapters/obsidian/sporty_obsidian_package_2026-05-30_072308.md`
- **Asset To Attach:** `Obsidian Campaign Brief note format`
- **CTA Link:** `Join the Brilliantier movement and unlock early access.`
