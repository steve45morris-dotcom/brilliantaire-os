# 📖 TTS Voice Model Offline Acquisition Guide: 2026-06-01
...
*   **Required Files:**
    1. One `.onnx` Piper voice model file (e.g., `en_US-lessac-low.onnx`)
    2. One matching `.json` configuration file (e.g., `en_US-lessac-low.json`)
...
---
**Next Action Recommended:** Acquire voice files manually and place them in the target directory.
